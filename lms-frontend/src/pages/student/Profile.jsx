          ...
          <div className="p-6">
            ...
            <div className="flex items-center gap-6 mb-8">
              <div className="relative">
                <div className="w-24 h-24 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {profile.role === 'MENTOR' && (
                    <Badge variant={getApprovalBadgeVariant(profile.approvalStatus)}>
            ...
            <div className="space-y-3">
              ...
              {profile.role === 'MENTOR' && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <Badge variant={getApprovalBadgeVariant(profile.approvalStatus)}>{profile.approvalStatus}</Badge>
                </div>
              )}
